...
class diceSpider(scrapy.Spider):
	...
	start_urls = ['https://www.dice.com/jobs/q-"back+end"+"full+stack"+"front+end"-limit-120-jobs.html']
	
	def parse(self, response):
		page = 1
		while response.css('.serp-result-content h3 a::attr(href)') and page < 10:
			url = 'https://www.dice.com/jobs/q-"back+end"+"full+stack"+"front+end"-startPage-'+str(page)+'-limit-120-jobs.html'
